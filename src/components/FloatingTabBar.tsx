...
export function FloatingTabBar({ active, onChange }: { active: AppScreen; onChange: (screen: AppScreen) => void }) {
  return (
    <nav className="pointer-events-auto absolute inset-x-4 bottom-4 z-20 rounded-full border border-white/70 bg-white/62 p-1.5 shadow-[0_20px_60px_rgba(15,23,42,0.18)] backdrop-blur-3xl">
